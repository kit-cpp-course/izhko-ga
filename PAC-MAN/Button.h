...
public:
	...
	sf::Vector2f RigthUp() { return sf::Vector2f(RecShButton.getPosition().x+WidthButton, RecShButton.getPosition().y); };
	sf::Vector2f RigthDown() { return sf::Vector2f(RecShButton.getPosition().x + WidthButton, RecShButton.getPosition().y+HeigthButton); };
